...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(@NotNull RecipeOutput output) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.SOUND_BLOCK.get())
                ...
                .unlockedBy(getHasName(ModItems.SAPPHIRE.get()), has(ModItems.SAPPHIRE.get()))
                .save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.SCHEMATIC_HOUSE_BUILDER.get())
                .pattern("PLP")
                .pattern("CDC")
                .pattern("PLP")
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.VILLAGER_HOUSE_BUILDER.get())
                .pattern("PLP")
                .pattern("CDC")
                .pattern("PLP")
    ...
    protected void buildToolRecipes(@NotNull RecipeOutput output){
    ...
    protected void buildArmorRecipes(@NotNull RecipeOutput output){
